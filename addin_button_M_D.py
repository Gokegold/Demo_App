...
class DemoApp(MDApp):
    ...
    def build(self):
        ...
        # The instance of the button is first created
        # Then the type of the button imported
        # From the type of button will be given attributes
        # Attributes like text 
        # The position of the button "Pos_hint" 'center_x for the x axises, 
        # then center_y for the y axises
        # How the button is to operate of function 'on_release'
